...
for iter in range(iterations):
    ...
    list_count_objects.append({"transformation_type": "uniform_complete", "numerical_count": N_numeric, "theoretical_count": N_theoretical * N, "objects_generated": N, "iteration": iter})
